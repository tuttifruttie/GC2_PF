...
public:
	TerrenoRR(int ancho, int alto, ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext)
	{
		...
		CargaParametros(L"Assets/grass.jpg", L"Assets/terreno7.jpg", 100.0f);
	}
	...
	bool CargaParametros(WCHAR* diffuseTex, WCHAR* heightTex, float tile)
	{
		...
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Assets/Ground_Dirt_007_basecolor.jpg", 0, 0, &colorMap, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Assets/Stone_Path_006_basecolor.jpg", 0, 0, &colorMap2, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Assets/Piedras.jpg", 0, 0, &colorMap3, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Assets/blendMapita6.jpg", 0, 0, &blendMap, 0);
